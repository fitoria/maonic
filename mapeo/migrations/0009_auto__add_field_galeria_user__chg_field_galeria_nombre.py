...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('mapeo_galeria', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)

        # Changing field 'Galeria.nombre'
        db.alter_column('mapeo_galeria', 'nombre', self.gf('django.db.models.fields.CharField')(max_length=140))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Galeria.nombre'
        db.alter_column('mapeo_galeria', 'nombre', self.gf('django.db.models.fields.CharField')(max_length=100))
